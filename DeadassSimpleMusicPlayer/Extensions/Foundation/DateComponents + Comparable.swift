...
extension DateComponents: @retroactive Comparable {
    ...
    public static func < (lhs: Self, rhs: Self) -> Bool {
        ...
        return if let lhs_date       = lhs.date,       let rhs_date = rhs.date,             lhs_date != rhs_date             { lhs_date       < rhs_date       }
          else if let lhs_era        = lhs.era,        let rhs_era = rhs.era,               lhs_era != rhs_era               { lhs_era        < rhs_era        }
